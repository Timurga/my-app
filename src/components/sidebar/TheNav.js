...
const activeNavItemClasses = 'flex items-center text-white bg-[#282828] mb-1 mx-2 px-4 py-2 rounded duration-300';
const navItemClasses = 'flex items-center hover:text-white hover:bg-[#282828] mb-1 mx-2 px-4 py-2 rounded duration-300';
